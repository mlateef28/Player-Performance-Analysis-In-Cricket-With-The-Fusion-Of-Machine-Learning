...
class Ui_BattersPerformance(object):
...
"font: 12pt \"Franklin Gothic Heavy\";")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Batters Performance"))
        self.label.setText(_translate("Dialog", "Predict  Batters Performance"))
