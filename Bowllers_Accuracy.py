...
class Ui_BowllersAccuracy(object):
...
"font: 12pt \"Franklin Gothic Heavy\";")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Bowlers Accuracy"))
        self.label.setText(_translate("Dialog", "Classify  Bowlers Accuracy"))
