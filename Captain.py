...
import sys
from CaptainHome import Ui_CaptainHome
class Ui_Captain(object):
    ...
    def logincheck(self):
        try:
            ...
            if unm == "" or unm == "null" or pwd == "" or pwd == "null":
                ...
                if unm == "captain" and pwd == "captain":
                    self.home = QtWidgets.QDialog()
                    self.ui = Ui_CaptainHome()
...
"color: rgb(255, 255, 255);")
        ...
        self.label_4.setStyleSheet("image: url(../Cricket/images/user.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Captain Login"))
        self.label.setText(_translate("Dialog", "        Captain Login"))
