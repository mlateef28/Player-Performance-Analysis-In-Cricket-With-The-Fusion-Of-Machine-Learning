...
import sys
from CoachHome import Ui_CoachHome
    ...
    def logincheck(self):
        try:
            ...
            if unm == "" or unm == "null" or pwd == "" or pwd == "null":
                ...
                if unm == "coach" and pwd == "coach":
                    self.home = QtWidgets.QDialog()
                    self.ui = Ui_CoachHome()
...
"color: rgb(255, 255, 255);")
        ...
        self.label_4.setStyleSheet("image: url(../Cricket/images/coach.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Coach Login"))
        self.label.setText(_translate("Dialog", "        Coach Login"))
